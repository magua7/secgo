...
- [1. JSONP Hijacking — Complete Attack Scenario](#1-jsonp-hijacking-complete-attack-scenario)
- [2. Same-Origin Policy — Deep Dive](#2-same-origin-policy-deep-dive)
- [3. CORS vs JSONP — Technical Comparison](#3-cors-vs-jsonp-technical-comparison)
- [4. CORS Exploitation Payloads](#4-cors-exploitation-payloads)
- [5. Dual-Site Attack Lab Pattern](#5-dual-site-attack-lab-pattern)
<!-- zhiyugo:toc:end -->
