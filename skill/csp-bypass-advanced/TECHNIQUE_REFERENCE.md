# SKILL: CSP Bypass — Advanced Techniques: detailed technique reference
...
- [2. BYPASS TECHNIQUES BY DIRECTIVE](#2-bypass-techniques-by-directive)
- [3. CSP IN META TAG vs. HEADER](#3-csp-in-meta-tag-vs-header)
- [4. DATA EXFILTRATION DESPITE CSP](#4-data-exfiltration-despite-csp)
- [5. CSP BYPASS DECISION TREE](#5-csp-bypass-decision-tree)
- [6. TRICK NOTES — WHAT AI MODELS MISS](#6-trick-notes-what-ai-models-miss)
<!-- zhiyugo:toc:end -->
...
└── All script execution blocked?
    ├── Dangling markup injection → exfil without JS (see `dangling-markup-injection`)
