...
- [1. Payment Precision and Overflow Attacks](#1-payment-precision-and-overflow-attacks)
- [2. Condition Race — Practical Patterns](#2-condition-race-practical-patterns)
- [3. Captcha Bypass Techniques](#3-captcha-bypass-techniques)
- [4. Arbitrary Password Reset Vulnerabilities](#4-arbitrary-password-reset-vulnerabilities)
- [5. User Information Enumeration](#5-user-information-enumeration)
- [6. Functional Restriction Bypass](#6-functional-restriction-bypass)
- [7. Denial of Service via Business Logic](#7-denial-of-service-via-business-logic)
- [8. PAYMENT MANIPULATION MATRIX](#8-payment-manipulation-matrix)
- [9. STATE MACHINE BYPASS METHODOLOGY](#9-state-machine-bypass-methodology)
<!-- zhiyugo:toc:end -->
