...
- [1. JAVA GADGET CHAIN VERSION COMPATIBILITY MATRIX](#1-java-gadget-chain-version-compatibility-matrix)
- [2. SNAKEYAML GADGET](#2-snakeyaml-gadget)
- [3. HESSIAN / KRYO / AVRO DESERIALIZATION](#3-hessian-kryo-avro-deserialization)
- [4. .NET VIEWSTATE DESERIALIZATION](#4-net-viewstate-deserialization)
- [5. RUBY YAML.load vs YAML.safe_load](#5-ruby-yamlload-vs-yamlsafeload)
- [6. DETECTION FINGERPRINTS — MAGIC BYTES TABLE](#6-detection-fingerprints-magic-bytes-table)
- [7. TOOLING QUICK REFERENCE](#7-tooling-quick-reference)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you need Java gadget chain version compatibility, SnakeYAML/Hessian/Kryo patterns, .NET ViewState forgery details, Ruby YAML exploitation, or deserialization fingerprint magic bytes. Assumes the main [SKILL.md](./SKILL.md) is already loaded for ysoserial basics, PHP/Python fundamentals.
