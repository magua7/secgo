# SKILL: Insecure Deserialization — Expert Attack Playbook: detailed technique reference
...
- [2. JAVA — GADGET CHAINS AND TOOLS](#2-java-gadget-chains-and-tools)
- [3. PHP — unserialize AND PHAR](#3-php-unserialize-and-phar)
- [4. PYTHON — PICKLE](#4-python-pickle)
- [5. DETECTION METHODOLOGY](#5-detection-methodology)
- [6. DEFENSE AWARENESS](#6-defense-awareness)
- [7. QUICK REFERENCE — KEY PAYLOADS](#7-quick-reference-key-payloads)
- [8. RUBY DESERIALIZATION](#8-ruby-deserialization)
- [9. .NET DESERIALIZATION](#9-net-deserialization)
- [10. NODE.JS DESERIALIZATION](#10-nodejs-deserialization)
...
- [11. RUBY DESERIALIZATION](#11-ruby-deserialization)
- [12. .NET DESERIALIZATION](#12-net-deserialization)
- [13. NODE.JS DESERIALIZATION](#13-nodejs-deserialization)
<!-- zhiyugo:toc:end -->
