...
- [1. COMMAND COMPARISON TABLE](#1-command-comparison-table)
- [2. COMMON INVESTIGATION SEQUENCES](#2-common-investigation-sequences)
- [3. PROFILE MANAGEMENT (Vol2)](#3-profile-management-vol2)
- [4. USEFUL GREP PATTERNS](#4-useful-grep-patterns)
<!-- zhiyugo:toc:end -->
