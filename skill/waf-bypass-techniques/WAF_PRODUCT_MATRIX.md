...
- [1. Cloudflare WAF](#1-cloudflare-waf)
- [2. AWS WAF](#2-aws-waf)
- [3. ModSecurity + OWASP CRS](#3-modsecurity-owasp-crs)
- [4. Akamai (Kona Site Defender / App & API Protector)](#4-akamai-kona-site-defender-app-api-protector)
- [5. Imperva / Incapsula](#5-imperva-incapsula)
- [6. F5 BIG-IP ASM / Advanced WAF](#6-f5-big-ip-asm-advanced-waf)
- [7. Sucuri WAF](#7-sucuri-waf)
- [8. QUICK REFERENCE — BYPASS-BY-WAF CHEAT SHEET](#8-quick-reference-bypass-by-waf-cheat-sheet)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you've identified the specific WAF product and need product-targeted bypass techniques. Assumes the main [SKILL.md](./SKILL.md) is already loaded for generic bypass methodology.
