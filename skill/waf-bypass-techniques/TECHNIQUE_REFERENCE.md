# SKILL: WAF Bypass Techniques — Evasion Playbook: detailed technique reference
...
- [2. GENERIC BYPASS CATEGORIES](#2-generic-bypass-categories)
- [3. PROTOCOL-LEVEL BYPASS TECHNIQUES](#3-protocol-level-bypass-techniques)
- [4. WAF BYPASS DECISION TREE](#4-waf-bypass-decision-tree)
- [5. COMMON MISTAKES & TRICK NOTES](#5-common-mistakes-trick-notes)
- [6. DEFENSE PERSPECTIVE](#6-defense-perspective)
<!-- zhiyugo:toc:end -->
...
- H2 → H1 downgrade may introduce request smuggling (see `request-smuggling`)
