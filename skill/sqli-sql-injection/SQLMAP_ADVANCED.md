...
- [1. SQLMAP — ADVANCED WORKFLOW](#1-sqlmap-advanced-workflow)
- [2. INSERT / UPDATE / DELETE INJECTION PATTERNS](#2-insert-update-delete-injection-patterns)
- [3. GRAPHQL + SQL INJECTION](#3-graphql-sql-injection)
- [4. DB-SPECIFIC ADVANCED FUNCTIONS](#4-db-specific-advanced-functions)
- [5. WAF BYPASS — ADVANCED TAMPER CHAIN PATTERNS](#5-waf-bypass-advanced-tamper-chain-patterns)
- [6. CHEAT SHEET — SQLMAP COMMAND COMBOS](#6-cheat-sheet-sqlmap-command-combos)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you need SQLMap tamper chain recipes, INSERT/UPDATE/DELETE injection patterns, GraphQL+SQLi, WAF bypass tamper stacking, or DB-specific advanced functions that Pay particular attention to. Assumes the main [SKILL.md](./SKILL.md) is already loaded for fundamentals.
