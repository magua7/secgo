...
- [1. SMB Out-of-Band Exfiltration (MySQL on Windows)](#1-smb-out-of-band-exfiltration-mysql-on-windows)
- [2. KEY Injection / URI Injection](#2-key-injection-uri-injection)
- [3. INSERT / DELETE / UPDATE Injection Differences](#3-insert-delete-update-injection-differences)
- [4. CVE Case: ThinkPHP5 SQL Injection](#4-cve-case-thinkphp5-sql-injection)
- [5. CVE Case: Django GIS SQL Injection (CVE-2020-9402)](#5-cve-case-django-gis-sql-injection-cve-2020-9402)
- [6. SQL Injection via Different SQL Verbs](#6-sql-injection-via-different-sql-verbs)
- [7. Universal Password Bypass Patterns](#7-universal-password-bypass-patterns)
- [8. DB2 Injection Specifics](#8-db2-injection-specifics)
- [9. Cassandra Injection Specifics (CQL)](#9-cassandra-injection-specifics-cql)
- [10. BigQuery Injection Specifics](#10-bigquery-injection-specifics)
- [11. SQLite Injection to RCE](#11-sqlite-injection-to-rce)
- [12. WAF Bypass Matrix](#12-waf-bypass-matrix)
- [13. CTF-Oriented Techniques](#13-ctf-oriented-techniques)
- [14. DB2 Injection Specifics](#14-db2-injection-specifics)
- [15. Cassandra (CQL) Injection Specifics](#15-cassandra-cql-injection-specifics)
- [16. BigQuery Injection Specifics](#16-bigquery-injection-specifics)
- [17. SQLite Injection to RCE](#17-sqlite-injection-to-rce)
- [18. CTF SQL Injection Techniques](#18-ctf-sql-injection-techniques)
<!-- zhiyugo:toc:end -->
