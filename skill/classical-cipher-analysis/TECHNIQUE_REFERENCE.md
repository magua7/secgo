# SKILL: Classical Cipher Analysis — Expert Cryptanalysis Playbook: detailed technique reference
...
- [2. MONOALPHABETIC SUBSTITUTION](#2-monoalphabetic-substitution)
- [3. CAESAR / ROT CIPHERS](#3-caesar-rot-ciphers)
- [4. VIGENERE CIPHER](#4-vigenere-cipher)
- [5. AFFINE CIPHER](#5-affine-cipher)
- [6. HILL CIPHER](#6-hill-cipher)
- [7. TRANSPOSITION CIPHERS](#7-transposition-ciphers)
- [8. XOR CIPHER](#8-xor-cipher)
- [9. SPECIAL CIPHERS](#9-special-ciphers)
