...
- [1. BLIND ROP (BROP)](#1-blind-rop-brop)
- [2. ret2vdso (32-bit ASLR Bypass)](#2-ret2vdso-32-bit-aslr-bypass)
- [3. PARTIAL OVERWRITE (PIE Bypass)](#3-partial-overwrite-pie-bypass)
- [4. JOP — Jump-Oriented Programming](#4-jop-jump-oriented-programming)
- [5. COP — Call-Oriented Programming](#5-cop-call-oriented-programming)
- [6. STACK-BASED ORW (open-read-write)](#6-stack-based-orw-open-read-write)
- [7. ret2csu EXTENDED PATTERNS](#7-ret2csu-extended-patterns)
- [8. ARCHITECTURE-SPECIFIC NOTES](#8-architecture-specific-notes)
- [9. TOOLCHAIN CHEAT SHEET](#9-toolchain-cheat-sheet)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you need Blind ROP methodology, ret2vdso for ASLR bypass, partial overwrite for PIE bypass, or alternative code-reuse paradigms (JOP/COP). Assumes the main [SKILL.md](./SKILL.md) is already loaded for fundamental ROP, ret2csu, ret2dlresolve, and SROP.
