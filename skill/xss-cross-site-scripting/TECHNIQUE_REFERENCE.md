# SKILL: Cross-Site Scripting (XSS) — Expert Attack Playbook: detailed technique reference
...
- [3. ADVANCED INJECTION VECTORS](#3-advanced-injection-vectors)
- [4. CSP BYPASS TECHNIQUES](#4-csp-bypass-techniques)
- [5. FILTER AND WAF BYPASS](#5-filter-and-waf-bypass)
- [6. SECOND-ORDER XSS](#6-second-order-xss)
- [7. BLIND XSS METHODOLOGY](#7-blind-xss-methodology)
- [8. XSS EXPLOITATION CHAIN](#8-xss-exploitation-chain)
- [9. DECISION TREE](#9-decision-tree)
- [10. XSS TESTING PROCESS (ZSEANO METHOD)](#10-xss-testing-process-zseano-method)
<!-- zhiyugo:toc:end -->
