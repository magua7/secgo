...
- [1. CVE Case: Django Debug Page XSS (CVE-2017-12794)](#1-cve-case-django-debug-page-xss-cve-2017-12794)
- [2. UTF-7 XSS (Legacy)](#2-utf-7-xss-legacy)
- [3. HttpOnly Bypass Strategies](#3-httponly-bypass-strategies)
- [4. XS-Leaks (Cross-Site Leak) Scenarios](#4-xs-leaks-cross-site-leak-scenarios)
- [5. Session Fixation via XSS](#5-session-fixation-via-xss)
- [6. DOM Clobbering](#6-dom-clobbering)
- [7. XSS POLYGLOT PAYLOADS](#7-xss-polyglot-payloads)
- [8. WAF BYPASS BY VENDOR](#8-waf-bypass-by-vendor)
- [9. CSP BYPASS TECHNIQUES](#9-csp-bypass-techniques)
- [10. CSS INJECTION DATA EXFILTRATION](#10-css-injection-data-exfiltration)
<!-- zhiyugo:toc:end -->
