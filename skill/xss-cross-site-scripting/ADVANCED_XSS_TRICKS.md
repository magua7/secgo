...
- [1. mXSS (Mutation XSS)](#1-mxss-mutation-xss)
- [2. DOM Clobbering](#2-dom-clobbering)
- [3. Modern Framework XSS](#3-modern-framework-xss)
- [4. Trusted Types Bypass](#4-trusted-types-bypass)
- [5. Service Worker XSS Persistence](#5-service-worker-xss-persistence)
- [6. PDF/SVG/XML XSS Vectors](#6-pdfsvgxml-xss-vectors)
- [7. XS-Leaks & Side Channels (Advanced)](#7-xs-leaks-side-channels-advanced)
- [8. Polyglot XSS Payloads](#8-polyglot-xss-payloads)
- [9. Browser-Specific Tricks](#9-browser-specific-tricks)
<!-- zhiyugo:toc:end -->
