# SKILL: Race Conditions — Testing & Exploitation Playbook: detailed technique reference
...
- [4. HTTP/2 SINGLE-PACKET ATTACK](#4-http2-single-packet-attack)
- [5. TURBO INTRUDER TEMPLATES](#5-turbo-intruder-templates)
- [6. CVE REFERENCE — CVE-2022-4037](#6-cve-reference-cve-2022-4037)
- [7. TOOLS](#7-tools)
- [8. DECISION TREE](#8-decision-tree)
- [9. HTTP/2 SINGLE-PACKET ATTACK — DETAILED MECHANICS](#9-http2-single-packet-attack-detailed-mechanics)
- [10. DATABASE ISOLATION LEVEL EXPLOITATION MATRIX](#10-database-isolation-level-exploitation-matrix)
- [11. LIMIT-OVERRUN ATTACK PATTERNS](#11-limit-overrun-attack-patterns)
- [12. SINGLE-PACKET MULTI-ENDPOINT ATTACK](#12-single-packet-multi-endpoint-attack)
- [Related](#related)
<!-- zhiyugo:toc:end -->
...
- **business-logic-vulnerabilities** — workflow, coupon abuse, and logic-first checklists (``business-logic-vulnerabilities``).
