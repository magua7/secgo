...
- [1. SSI Injection (Server-Side Includes)](#1-ssi-injection-server-side-includes)
- [2. LDAP Injection](#2-ldap-injection)
- [3. XPath Injection](#3-xpath-injection)
- [4. LaTeX Injection](#4-latex-injection)
- [5. Encoding Transformation Bypass](#5-encoding-transformation-bypass)
- [6. PHP External Variable Modification](#6-php-external-variable-modification)
<!-- zhiyugo:toc:end -->
