...
- [1. DYLIB HIJACKING METHODOLOGY](#1-dylib-hijacking-methodology)
- [2. XPC EXPLOITATION WALKTHROUGH](#2-xpc-exploitation-walkthrough)
- [3. MACH PORT TECHNIQUES](#3-mach-port-techniques)
- [4. ELECTRON-SPECIFIC DEEP DIVE](#4-electron-specific-deep-dive)
- [5. INJECTION TECHNIQUE COMPARISON MATRIX](#5-injection-technique-comparison-matrix)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you need detailed dylib hijacking methodology, XPC exploitation walkthroughs, or Mach port technique specifics. Assumes the main [SKILL.md](./SKILL.md) is already loaded for injection vector overview.
