# SKILL: Mobile SSL Pinning Bypass — Expert Attack Playbook: detailed technique reference
...
- [2. ANDROID BYPASS METHODS](#2-android-bypass-methods)
- [3. iOS BYPASS METHODS](#3-ios-bypass-methods)
- [4. FRAMEWORK-SPECIFIC BYPASSES](#4-framework-specific-bypasses)
- [5. CERTIFICATE TRANSPARENCY & HPKP](#5-certificate-transparency-hpkp)
- [6. TROUBLESHOOTING](#6-troubleshooting)
- [7. SSL PINNING BYPASS DECISION TREE](#7-ssl-pinning-bypass-decision-tree)
- [8. PROXY SETUP QUICK REFERENCE](#8-proxy-setup-quick-reference)
<!-- zhiyugo:toc:end -->
