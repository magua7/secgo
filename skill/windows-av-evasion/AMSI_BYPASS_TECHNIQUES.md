...
- [1. AMSI ARCHITECTURE](#1-amsi-architecture)
- [2. MEMORY PATCHING — AmsiScanBuffer](#2-memory-patching-amsiscanbuffer)
- [3. REFLECTION-BASED BYPASS](#3-reflection-based-bypass)
- [4. POWERSHELL-SPECIFIC BYPASSES](#4-powershell-specific-bypasses)
- [5. .NET AMSI BYPASS](#5-net-amsi-bypass)
- [6. COM-BASED AMSI BYPASS](#6-com-based-amsi-bypass)
- [7. HARDWARE BREAKPOINT BYPASS](#7-hardware-breakpoint-bypass)
- [8. AMSI BYPASS DECISION TREE](#8-amsi-bypass-decision-tree)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for detailed AMSI bypass code patterns, PowerShell-specific bypasses, .NET AMSI bypass, and Constrained Language Mode escape. Assumes the main [SKILL.md](./SKILL.md) is already loaded for general AV/EDR evasion concepts.
