# SKILL: Lattice-Based Cryptanalysis — Expert Attack Playbook: detailed technique reference
...
- [5. HIDDEN NUMBER PROBLEM (HNP) — DSA/ECDSA NONCE RECOVERY](#5-hidden-number-problem-hnp-dsaecdsa-nonce-recovery)
- [6. KNAPSACK / SUBSET SUM ATTACKS](#6-knapsack-subset-sum-attacks)
- [7. NTRU CRYPTANALYSIS](#7-ntru-cryptanalysis)
- [8. CONSTRUCTING ATTACK LATTICES — METHODOLOGY](#8-constructing-attack-lattices-methodology)
