...
- [1. PERSONA-BASED JAILBREAKS](#1-persona-based-jailbreaks)
- [2. HYPOTHETICAL / FICTION FRAMING](#2-hypothetical-fiction-framing)
- [3. ENCODING & OBFUSCATION TECHNIQUES](#3-encoding-obfuscation-techniques)
- [4. MULTI-STEP ESCALATION](#4-multi-step-escalation)
- [5. SYSTEM PROMPT EXTRACTION TECHNIQUES](#5-system-prompt-extraction-techniques)
- [6. MODEL-SPECIFIC CONSIDERATIONS](#6-model-specific-considerations)
- [7. MULTIMODAL JAILBREAKS](#7-multimodal-jailbreaks)
- [8. DEFENSE AWARENESS](#8-defense-awareness)
- [9. RESPONSIBLE TESTING FRAMEWORK](#9-responsible-testing-framework)
<!-- zhiyugo:toc:end -->
