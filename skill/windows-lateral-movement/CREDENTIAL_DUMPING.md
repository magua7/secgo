...
- [1. LSASS MEMORY DUMP TECHNIQUES](#1-lsass-memory-dump-techniques)
- [2. SAM / SYSTEM / SECURITY HIVE EXTRACTION](#2-sam-system-security-hive-extraction)
- [3. DPAPI SECRETS](#3-dpapi-secrets)
- [4. CACHED DOMAIN CREDENTIALS](#4-cached-domain-credentials)
- [5. NTDS.DIT EXTRACTION (DOMAIN CONTROLLER)](#5-ntdsdit-extraction-domain-controller)
- [6. WINDOWS CREDENTIAL LOCATIONS SUMMARY](#6-windows-credential-locations-summary)
- [7. CREDENTIAL DUMP DECISION TREE](#7-credential-dump-decision-tree)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for LSASS dump methods, SAM/SYSTEM extraction, DPAPI secrets, cached domain credentials, and NTDS.dit extraction. Assumes the main [SKILL.md](./SKILL.md) is already loaded for lateral movement techniques.
