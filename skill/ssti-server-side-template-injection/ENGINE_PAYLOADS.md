...
- [1. ENGINE FINGERPRINTING DECISION TREE](#1-engine-fingerprinting-decision-tree)
- [2. JINJA2 (PYTHON)](#2-jinja2-python)
- [3. TWIG (PHP)](#3-twig-php)
- [4. FREEMARKER (JAVA)](#4-freemarker-java)
- [5. VELOCITY (JAVA)](#5-velocity-java)
- [6. PEBBLE (JAVA)](#6-pebble-java)
- [7. MAKO (PYTHON)](#7-mako-python)
- [8. SLIM (RUBY)](#8-slim-ruby)
- [9. HANDLEBARS (NODE.JS)](#9-handlebars-nodejs)
- [10. THYMELEAF (JAVA / SPRING)](#10-thymeleaf-java-spring)
- [11. SMARTY (PHP)](#11-smarty-php)
- [12. ERB (RUBY)](#12-erb-ruby)
- [13. JADE / PUG (NODE.JS)](#13-jade-pug-nodejs)
- [14. BLIND SSTI DETECTION](#14-blind-ssti-detection)
<!-- zhiyugo:toc:end -->
