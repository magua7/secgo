...
- [1. TOKEN PRIVILEGE PRIMER](#1-token-privilege-primer)
- [2. POTATO FAMILY EVOLUTION](#2-potato-family-evolution)
- [3. DETAILED COMPARISON MATRIX](#3-detailed-comparison-matrix)
- [4. TOOL USAGE — COMMAND REFERENCE](#4-tool-usage-command-reference)
- [5. SeBackupPrivilege EXPLOITATION](#5-sebackupprivilege-exploitation)
- [6. SeLoadDriverPrivilege EXPLOITATION](#6-seloaddriverprivilege-exploitation)
- [7. POTATO SELECTION DECISION TREE](#7-potato-selection-decision-tree)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for in-depth Potato exploit selection, token privilege prerequisites, OS-version matrices, and protocol-level details. Assumes the main [SKILL.md](./SKILL.md) is already loaded for general Windows privesc flow.
