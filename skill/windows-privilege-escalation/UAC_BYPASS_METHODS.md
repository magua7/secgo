...
- [1. UAC FUNDAMENTALS](#1-uac-fundamentals)
- [2. UAC BYPASS TECHNIQUE MATRIX](#2-uac-bypass-technique-matrix)
- [3. DETAILED BYPASS TECHNIQUES](#3-detailed-bypass-techniques)
- [4. UACME TOOL REFERENCE](#4-uacme-tool-reference)
- [5. UAC BYPASS DECISION TREE](#5-uac-bypass-decision-tree)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for UAC bypass technique selection, auto-elevate binary abuse, and mock trusted directory tricks. Assumes the main [SKILL.md](./SKILL.md) is already loaded for general Windows privesc flow. UAC bypass takes you from medium integrity → high integrity (local admin).
