...
- [Recipe 1: Basic find/avoid by Address](#recipe-1-basic-findavoid-by-address)
- [Recipe 2: Find by stdout Content](#recipe-2-find-by-stdout-content)
- [Recipe 3: Symbolic stdin with Printable Constraint](#recipe-3-symbolic-stdin-with-printable-constraint)
- [Recipe 4: Symbolic argv](#recipe-4-symbolic-argv)
- [Recipe 5: Symbolic File Input](#recipe-5-symbolic-file-input)
- [Recipe 6: Hook scanf](#recipe-6-hook-scanf)
- [Recipe 7: Hook strcmp to Leak Expected Value](#recipe-7-hook-strcmp-to-leak-expected-value)
- [Recipe 8: Start from Specific Function (skip initialization)](#recipe-8-start-from-specific-function-skip-initialization)
- [Recipe 9: Veritesting (Merge Paths at Branches)](#recipe-9-veritesting-merge-paths-at-branches)
- [Recipe 10: Unicorn Concrete Execution Speedup](#recipe-10-unicorn-concrete-execution-speedup)
- [Recipe 11: Multi-Stage Binary (Sequential Checks)](#recipe-11-multi-stage-binary-sequential-checks)
- [Recipe 12: Constrain Flag Format (CTF{...})](#recipe-12-constrain-flag-format-ctf)
- [Recipe 13: Replace rand() with Concrete Value](#recipe-13-replace-rand-with-concrete-value)
- [Recipe 14: Timeout + DFS for Deep Binaries](#recipe-14-timeout-dfs-for-deep-binaries)
- [Recipe 15: Symbolic Memory at Global Buffer](#recipe-15-symbolic-memory-at-global-buffer)
- [Adaptation Checklist](#adaptation-checklist)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you need drop-in angr script templates for common CTF challenge patterns. Each recipe includes the scenario description, complete script, and adaptation notes. Assumes the main [SKILL.md](./SKILL.md) is already loaded for angr fundamentals.
