...
- [1. COERCION METHODS MATRIX](#1-coercion-methods-matrix)
- [2. PETITPOTAM — MS-EFSR ABUSE](#2-petitpotam-ms-efsr-abuse)
- [3. PRINTERBUG — MS-RPRN (SPOOLSAMPLE)](#3-printerbug-ms-rprn-spoolsample)
- [4. DFSCOERCE — MS-DFSNM](#4-dfscoerce-ms-dfsnm)
- [5. SHADOWCOERCE — MS-FSRVP](#5-shadowcoerce-ms-fsrvp)
- [6. COERCER — AUTOMATED DISCOVERY TOOL](#6-coercer-automated-discovery-tool)
- [7. COERCION + RELAY ATTACK COMBINATIONS](#7-coercion-relay-attack-combinations)
- [8. COERCION METHOD SELECTION TREE](#8-coercion-method-selection-tree)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for detailed authentication coercion method comparison, RPC function-level details, and the Coercer tool usage. Assumes the main [SKILL.md](./SKILL.md) is already loaded for NTLM relay fundamentals.
