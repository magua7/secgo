...
- [1. CVE Case: WebLogic SSRF (CVE-2014-4210)](#1-cve-case-weblogic-ssrf-cve-2014-4210)
- [2. DNS Rebinding — Deep Dive](#2-dns-rebinding-deep-dive)
- [3. CVE Case: Kubernetes SSRF (CVE-2020-8555 / CVE-2020-8562)](#3-cve-case-kubernetes-ssrf-cve-2020-8555-cve-2020-8562)
- [4. SSRF Through PDF/Screenshot Generators](#4-ssrf-through-pdfscreenshot-generators)
- [5. SSRF + Gopher Protocol — Full TCP Injection](#5-ssrf-gopher-protocol-full-tcp-injection)
- [6. Filter Bypass via URL Parser Confusion](#6-filter-bypass-via-url-parser-confusion)
- [7. EXTENDED CLOUD METADATA ENDPOINTS](#7-extended-cloud-metadata-endpoints)
- [8. BROWSER-SIDE DNS REBINDING & HEADLESS BROWSER ATTACKS](#8-browser-side-dns-rebinding-headless-browser-attacks)
<!-- zhiyugo:toc:end -->
