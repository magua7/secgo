...
- [1. URL PARSER DIFFERENTIAL TABLE](#1-url-parser-differential-table)
- [2. FULL CLOUD METADATA ENDPOINT CATALOG](#2-full-cloud-metadata-endpoint-catalog)
- [3. GOPHER:// PAYLOAD RECIPES](#3-gopher-payload-recipes)
- [4. DNS REBINDING — DETAILED ATTACK FLOW](#4-dns-rebinding-detailed-attack-flow)
- [5. PDF / SCREENSHOT GENERATOR SSRF](#5-pdf-screenshot-generator-ssrf)
- [6. ADDITIONAL BYPASS TECHNIQUES](#6-additional-bypass-techniques)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you need URL parser confusion tables, full cloud metadata endpoint catalogs, gopher:// payload recipes, DNS rebinding deep dives, or headless-browser/PDF-generator SSRF patterns. Assumes the main [SKILL.md](./SKILL.md) is already loaded for fundamentals.
