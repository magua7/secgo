...
- [1. RESPONDER CONFIGURATION](#1-responder-configuration)
- [2. RELAY TARGET SELECTION](#2-relay-target-selection)
- [3. CREDENTIAL FORMAT ANALYSIS](#3-credential-format-analysis)
- [4. mitm6 DETAILED WORKFLOW](#4-mitm6-detailed-workflow)
