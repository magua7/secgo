...
- [1. FACTORIZATION METHODS — DETAILED](#1-factorization-methods-detailed)
- [2. SMALL EXPONENT ATTACKS — DETAILED](#2-small-exponent-attacks-detailed)
- [3. WIENER'S ATTACK — COMPLETE IMPLEMENTATION](#3-wieners-attack-complete-implementation)
- [4. BONEH-DURFEE — SAGE IMPLEMENTATION](#4-boneh-durfee-sage-implementation)
- [5. LSB ORACLE ATTACK — COMPLETE](#5-lsb-oracle-attack-complete)
- [6. BLEICHENBACHER ATTACK — ALGORITHM OUTLINE](#6-bleichenbacher-attack-algorithm-outline)
- [7. RSA-CRT FAULT — MATHEMATICAL DERIVATION](#7-rsa-crt-fault-mathematical-derivation)
- [8. MULTI-PRIME RSA](#8-multi-prime-rsa)
- [9. KNOWN e·d → FACTOR n](#9-known-ed-factor-n)
- [10. ATTACK CONDITIONS SUMMARY](#10-attack-conditions-summary)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you need full mathematical derivations, complete SageMath/Python implementations, and edge-case handling for each RSA attack. Assumes the main [SKILL.md](./SKILL.md) is already loaded for attack selection and decision trees.
