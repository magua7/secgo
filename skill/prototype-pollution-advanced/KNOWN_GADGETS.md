...
- [1. EXPRESS TEMPLATE ENGINES (Server-Side → RCE)](#1-express-template-engines-server-side-rce)
- [2. LODASH](#2-lodash)
- [3. JQUERY](#3-jquery)
- [4. ANGULAR.JS (1.x)](#4-angularjs-1x)
- [5. VUE.JS](#5-vuejs)
- [6. WEBPACK](#6-webpack)
- [7. FASTIFY](#7-fastify)
- [8. NODE.JS CORE](#8-nodejs-core)
- [9. MISCELLANEOUS LIBRARIES](#9-miscellaneous-libraries)
- [10. GADGET SELECTION FLOWCHART](#10-gadget-selection-flowchart)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Comprehensive gadget table for prototype pollution exploitation. Load this when you've confirmed PP and need to find a matching gadget for the target's framework/library. Each entry includes the polluted property, trigger condition, impact (XSS/RCE), and affected versions.
