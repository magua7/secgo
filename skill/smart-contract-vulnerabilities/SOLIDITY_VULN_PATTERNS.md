...
- [1. REENTRANCY — VULNERABLE VS FIXED](#1-reentrancy-vulnerable-vs-fixed)
- [2. INTEGER OVERFLOW / UNDERFLOW](#2-integer-overflow-underflow)
- [3. ACCESS CONTROL](#3-access-control)
- [4. DELEGATECALL STORAGE COLLISION](#4-delegatecall-storage-collision)
- [5. RANDOMNESS MANIPULATION](#5-randomness-manipulation)
- [6. SIGNATURE REPLAY](#6-signature-replay)
- [7. SELF-DESTRUCT FORCE-SEND ETH](#7-self-destruct-force-send-eth)
- [8. FLASH LOAN ORACLE MANIPULATION](#8-flash-loan-oracle-manipulation)
- [9. UNCHECKED RETURN VALUE](#9-unchecked-return-value)
- [10. DENIAL OF SERVICE — UNEXPECTED REVERT](#10-denial-of-service-unexpected-revert)
- [11. GAS OPTIMIZATION TRAPS](#11-gas-optimization-traps)
<!-- zhiyugo:toc:end -->
