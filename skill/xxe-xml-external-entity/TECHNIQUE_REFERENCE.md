# SKILL: XML External Entity Injection (XXE) — Expert Attack Playbook: detailed technique reference
...
- [7. SOAP ENDPOINT XXE](#7-soap-endpoint-xxe)
- [8. XXE → SSRF CHAIN](#8-xxe-ssrf-chain)
- [9. XInclude ATTACK](#9-xinclude-attack)
- [10. PROTOCOL HANDLERS IN XXE](#10-protocol-handlers-in-xxe)
- [11. BYPASSING DEFENSES](#11-bypassing-defenses)
- [12. QUICK DETECTION CHECKLIST](#12-quick-detection-checklist)
- [13. LOCAL DTD INJECTION (BLIND XXE AMPLIFICATION)](#13-local-dtd-injection-blind-xxe-amplification)
- [14. ADDITIONAL OOB EXFILTRATION CHANNELS](#14-additional-oob-exfiltration-channels)
- [15. DTD NESTING TRICKS — PARAMETER ENTITY CHAINING](#15-dtd-nesting-tricks-parameter-entity-chaining)
- [16. XXE IN NON-OBVIOUS FORMATS](#16-xxe-in-non-obvious-formats)
- [17. XXE VIA FILE UPLOAD](#17-xxe-via-file-upload)
- [18. ERROR-BASED XXE](#18-error-based-xxe)
- [19. XSLT INJECTION CONNECTION TO XXE](#19-xslt-injection-connection-to-xxe)
<!-- zhiyugo:toc:end -->
