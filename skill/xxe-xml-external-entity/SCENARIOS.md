...
- [1. CVE Case: Apache Solr XXE + RCE (CVE-2017-12629)](#1-cve-case-apache-solr-xxe-rce-cve-2017-12629)
- [2. Office Document XXE — Step-by-Step](#2-office-document-xxe-step-by-step)
- [3. DOCTYPE-Based SSRF](#3-doctype-based-ssrf)
- [4. PHP expect:// Protocol via XXE](#4-php-expect-protocol-via-xxe)
- [5. XXE in SOAP Web Services](#5-xxe-in-soap-web-services)
- [6. Blind XXE via Error Messages](#6-blind-xxe-via-error-messages)
<!-- zhiyugo:toc:end -->
