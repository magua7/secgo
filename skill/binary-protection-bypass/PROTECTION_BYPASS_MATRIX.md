...
- [1. PROTECTION × BYPASS × PRIMITIVE MATRIX](#1-protection-bypass-primitive-matrix)
- [2. COMBINED PROTECTION SCENARIOS](#2-combined-protection-scenarios)
- [3. COMPILATION FLAGS REFERENCE](#3-compilation-flags-reference)
- [4. PROTECTION INTERACTION EFFECTS](#4-protection-interaction-effects)
- [5. QUICK LOOKUP: "I HAVE X, I NEED Y"](#5-quick-lookup-i-have-x-i-need-y)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for a systematic lookup of which bypass technique works against which protection, and what primitive is required. Assumes [SKILL.md](./SKILL.md) is loaded for individual protection details.
