...
- [1. WEB CACHE POISONING vs WEB CACHE DECEPTION](#1-web-cache-poisoning-vs-web-cache-deception)
- [2. UNKEYED HEADER POISONING](#2-unkeyed-header-poisoning)
- [3. UNKEYED PARAMETER POISONING](#3-unkeyed-parameter-poisoning)
- [4. FAT GET CACHE POISONING](#4-fat-get-cache-poisoning)
- [5. PARAMETER CLOAKING](#5-parameter-cloaking)
- [6. CDN-SPECIFIC BEHAVIOR](#6-cdn-specific-behavior)
- [7. VARY HEADER MANIPULATION](#7-vary-header-manipulation)
- [8. ADVANCED TECHNIQUES](#8-advanced-techniques)
- [9. TESTING CHECKLIST](#9-testing-checklist)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you need clear cache poisoning vs deception distinction, unkeyed header/parameter poisoning techniques, Fat GET cache poisoning, parameter cloaking, CDN-specific behavior, or Vary header attacks. Assumes the main [SKILL.md](./SKILL.md) is already loaded for cache deception fundamentals.
