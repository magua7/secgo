...
- [1. ESCAPE CHAIN: PRIVILEGED CONTAINER → HOST ROOT](#1-escape-chain-privileged-container-host-root)
- [2. ESCAPE CHAIN: DOCKER SOCKET → HOST ROOT](#2-escape-chain-docker-socket-host-root)
- [3. ESCAPE CHAIN: CGROUP RELEASE_AGENT → HOST COMMAND EXECUTION](#3-escape-chain-cgroup-releaseagent-host-command-execution)
- [4. DOCKER-IN-DOCKER (DinD) ESCAPE](#4-docker-in-docker-dind-escape)
- [5. KUBERNETES-SPECIFIC ESCAPE PATHS](#5-kubernetes-specific-escape-paths)
- [6. ESCAPE CHAIN SELECTION MATRIX](#6-escape-chain-selection-matrix)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for step-by-step container escape chains covering common misconfigurations, Docker-in-Docker scenarios, and Kubernetes-specific escape sequences. Assumes the main [SKILL.md](./SKILL.md) is already loaded for fundamental escape techniques.
