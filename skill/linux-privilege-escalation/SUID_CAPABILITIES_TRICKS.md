...
- [1. TOP 30 SUID BINARIES — EXPLOITATION COMMANDS](#1-top-30-suid-binaries-exploitation-commands)
- [2. CAPABILITY-SPECIFIC EXPLOITATION](#2-capability-specific-exploitation)
- [3. CUSTOM SUID BINARY EXPLOITATION](#3-custom-suid-binary-exploitation)
- [4. QUICK-REFERENCE: CAPABILITIES → EXPLOITATION](#4-quick-reference-capabilities-exploitation)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for detailed SUID binary exploitation commands (GTFOBins top 30), capability-specific abuse techniques, and custom SUID exploitation methodology. Assumes the main [SKILL.md](./SKILL.md) is already loaded for enumeration and general privesc flow.
