...
- [1. PADDING ORACLE — FULL WALKTHROUGH](#1-padding-oracle-full-walkthrough)
- [2. CBC BIT FLIPPING — ADVANCED SCENARIOS](#2-cbc-bit-flipping-advanced-scenarios)
- [3. ECB BYTE-AT-A-TIME — COMPLETE WALKTHROUGH](#3-ecb-byte-at-a-time-complete-walkthrough)
- [4. LCG STATE RECOVERY](#4-lcg-state-recovery)
- [5. MERSENNE TWISTER STATE RECOVERY](#5-mersenne-twister-state-recovery)
- [6. AES KEY SCHEDULE WEAKNESS EXPLOITATION](#6-aes-key-schedule-weakness-exploitation)
- [7. GCM NONCE REUSE](#7-gcm-nonce-reuse)
- [8. PRACTICAL TIPS](#8-practical-tips)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this when you need full attack implementations, step-by-step walkthroughs, and edge-case handling for block cipher exploitation. Assumes the main [SKILL.md](./SKILL.md) is already loaded for attack selection and decision trees.
