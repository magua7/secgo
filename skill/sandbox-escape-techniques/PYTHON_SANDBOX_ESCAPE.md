...
- [1. __builtins__ RECOVERY VIA SUBCLASS WALKING](#1-builtins-recovery-via-subclass-walking)
- [2. KEYWORD BYPASS TECHNIQUES](#2-keyword-bypass-techniques)
- [3. AST-BASED SANDBOX BYPASS](#3-ast-based-sandbox-bypass)
- [4. RESTRICTEDPYTHON BYPASS](#4-restrictedpython-bypass)
- [5. FILE READ WITHOUT open()](#5-file-read-without-open)
- [6. PICKLE DESERIALIZATION ESCAPE](#6-pickle-deserialization-escape)
- [7. CODE OBJECT MANIPULATION](#7-code-object-manipulation)
- [8. PYTHON 2 vs PYTHON 3 DIFFERENCES](#8-python-2-vs-python-3-differences)
- [9. CTF PYJAIL QUICK CHECKLIST](#9-ctf-pyjail-quick-checklist)
- [10. DECISION TREE](#10-decision-tree)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for complete pyjail escape techniques. Covers `__builtins__` recovery via subclass walking, keyword bypass via `getattr`/`chr()`, AST-based sandbox bypass, RestrictedPython escape, exec with custom globals, file read without `open()`, pickle deserialization, and code object manipulation. Assumes [SKILL.md](./SKILL.md) is loaded for sandbox type identification.
