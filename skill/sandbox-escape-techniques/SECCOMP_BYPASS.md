...
- [1. SECCOMP FUNDAMENTALS](#1-seccomp-fundamentals)
- [2. ARCHITECTURE CONFUSION](#2-architecture-confusion)
- [3. ORW (OPEN-READ-WRITE) CHAIN](#3-orw-open-read-write-chain)
- [4. io_uring BYPASS](#4-iouring-bypass)
- [5. PTRACE-BASED BYPASS](#5-ptrace-based-bypass)
- [6. ALLOWED SYSCALL CHAINING](#6-allowed-syscall-chaining)
- [7. NAMESPACE + SECCOMP INTERACTION](#7-namespace-seccomp-interaction)
- [8. RETURN VALUE MANIPULATION](#8-return-value-manipulation)
- [9. DECISION TREE](#9-decision-tree)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for seccomp filter bypass techniques. Covers architecture confusion (x86_64/x86 syscall number mismatch), io_uring bypass, ptrace-based bypass, allowed syscall chaining for ORW, namespace escape, and return value manipulation. Assumes [SKILL.md](./SKILL.md) is loaded for sandbox type identification.
