...
- [1. BLOODHOUND DATA COLLECTION BEST PRACTICES](#1-bloodhound-data-collection-best-practices)
- [2. ESSENTIAL CYPHER QUERIES](#2-essential-cypher-queries)
- [3. COMMON ATTACK PATH PATTERNS](#3-common-attack-path-patterns)
- [4. CUSTOM BLOODHOUND QUERIES FOR SPECIFIC SCENARIOS](#4-custom-bloodhound-queries-for-specific-scenarios)
- [5. BLOODHOUND CE (COMMUNITY EDITION) TIPS](#5-bloodhound-ce-community-edition-tips)
- [6. ATTACK PATH DECISION FLOW](#6-attack-path-decision-flow)
<!-- zhiyugo:toc:end -->

> **Technical reference scope**: Load this for common BloodHound attack paths, custom Cypher queries for Neo4j, and chain analysis techniques. Assumes the main [SKILL.md](./SKILL.md) is already loaded for individual ACL abuse techniques.
