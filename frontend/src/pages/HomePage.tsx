...
export function HomePage({ theme, onThemeToggle, onOpenSettings }: { theme: Theme; onThemeToggle: () => void; onOpenSettings: () => void }) {
  ...
  return <div className="home-page page-texture">
    <TopBar theme={theme} active="home" onThemeToggle={onThemeToggle} onOpenSettings={onOpenSettings} />
